...
/* compound read/write */
extern int i2c_read8(const i2c_io *p,i2c_addr);
extern long int i2c_read16(const i2c_io *p,i2c_addr);
extern long int i2c_read24(const i2c_io *p,i2c_addr);
extern bool i2c_write8(const i2c_io *p,i2c_addr,u8 val);
